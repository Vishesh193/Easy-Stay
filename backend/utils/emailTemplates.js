export const otpEmailTemplate = (name, otp) => {
    return `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <p>Hello ${name},</p>
            <p>Welcome to Airbnb Clone! Please use the following OTP to verify your email address:</p>
...
export const welcomeEmailTemplate = (name) => {
    return `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            <h2 style="color: #FF5A5F;">Welcome to Airbnb Clone!</h2>
            <p>Hello ${name},</p>
            <p>Thank you for signing up with our Airbnb Clone. We're excited to have you on board!</p>
            <p>You can now:</p>
            <ul>
...
export const loginNotificationTemplate = (name) => {
    return `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <p>Hello ${name},</p>
            <p>We noticed a new login to your Airbnb Clone account.</p>
